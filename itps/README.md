...
molecular topologies, listed by resname. For convenience, 
a combined topology file `all_metabolites.itp` is also provided, 
which includes all individual molecule topologies in a single file. If a nucleotide 
topology is used, the [`martini_v3.0.0_nucleotide_ffbonded_v1.itp`](bonded/martini_v3.0.0_nucleotide_ffbonded_v1.itp)
